...
class com.bourre.ioc.assembler.channel.ChannelListenerEvent 
	extends BasicEvent 
{
	public static var onBuildChannelListenerEVENT : EventType = new EventType( "onBuildChannelListener" );
