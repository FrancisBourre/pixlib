	...
	private function _onStatus ( info : Object ) : Void
	{
		switch ( info.code ) 
		{
			...
			case 'NetStream.Buffer.Flush' :
				//PixlibDebug.DEBUG( this + ".NetStream.Buffer.Flush." );
				fireEventType( VideoDisplay.onBufferFlushEVENT );
				break;
		}
	}
